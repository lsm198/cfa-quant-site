window.TOPIC_META = {
  ...
  "vocabulary": [
    { "term_en": "bootstrap resampling", "meaning_zh": "自举重抽样:从原始样本里有放回地反复抽取样本,每次抽样量等于原样本大小", "example_en": "An analyst draws samples from an original sample to estimate the standard error of a population mean; this sampling procedure is best described as the bootstrap method." },
    ...
    { "term_en": "standard error of the sample mean", "meaning_zh": "样本均值的标准误,用来衡量样本均值本身的波动/不确定性", "example_en": "The mean of each resample is required to compute the standard error of a sample mean using the bootstrap resampling method." }
  ],
  "mnemonics": [
