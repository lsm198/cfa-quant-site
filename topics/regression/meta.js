window.TOPIC_META = {
  ...
  "vocabulary": [
    { "term_en": "dependent variable / explained variable", "meaning_zh": "因变量/被解释变量:回归想要解释和预测的那个变量,通常记为 Y", "example_en": "The variation in the supply of wheat, being explained by the variation in the demand for corn, makes the supply of wheat the dependent variable, or explained variable." },
    ...
    { "term_en": "prediction interval", "meaning_zh": "预测区间:给定一个新 X 值,对相应 Y 值给出的一个不确定性区间,比回归线的置信区间更宽", "example_en": "Given a forecasted value of the independent variable, the 95% prediction interval for the dependent variable is 1.9% to 7.5%." },
    { "term_en": "ANOVA (analysis of variance)", "meaning_zh": "方差分析:把因变量的总变异(SST)拆解成回归能解释的部分(SSR)和不能解释的残差部分(SSE)", "example_en": "In simple linear regression analysis, the total sum of squares best describes the variation of the dependent variable." }
  ],
  "mnemonics": [
