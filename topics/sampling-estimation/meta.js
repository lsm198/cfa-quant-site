window.TOPIC_META = {
  ...
  "vocabulary": [
    ...
    { "term_en": "stratified random sampling", "meaning_zh": "分层随机抽样:先按某种标准把总体分成若干层,再按各层占总体的比例分别随机抽样", "example_en": "Grouping all publicly traded US firms by sector and then randomly selecting subsamples from each sector according to the sector's proportion in the population is an example of stratified random sampling." },
    { "term_en": "cluster sampling", "meaning_zh": "整群抽样:把总体分成若干「群」(每个群本身就是总体的缩影),再随机抽取整个群", "example_en": "Cluster sampling is most likely used when conducting a market survey." },
    { "term_en": "convenience / judgmental sampling", "meaning_zh": "便利/判断抽样:非概率抽样,依据抽样者的方便程度或主观判断选样本,代表性差", "example_en": "An analyst who selects stocks whose company names start with the letter P is using non-probability sampling." },
    ...
    { "term_en": "central limit theorem (CLT)", "meaning_zh": "中心极限定理:当样本量足够大时,不论总体分布形状如何,样本均值的抽样分布都近似服从正态分布", "example_en": "The central limit theorem implies that the sample mean is a consistent estimator of the population mean." },
