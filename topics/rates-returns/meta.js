window.TOPIC_META = {
  ...
  "vocabulary": [
    { "term_en": "Holding Period Return (HPR)", "meaning_zh": "持有期收益率:某笔投资从买入到卖出这一段持有期内赚的总回报率", "example_en": "An investor purchases a stock for $100. Immediately after receiving a dividend of $7, the investor sells the stock for $107. The holding period return of the investment is closest to 14%." },
    { "term_en": "money-weighted rate of return (MWRR)", "meaning_zh": "资金加权收益率:本质就是内部收益率 IRR,反映投资者自己实际赚了多少,受资金进出时点影响", "example_en": "The money-weighted return measures what the investor actually earned on the funds invested." },
    { "term_en": "time-weighted rate of return (TWRR)", "meaning_zh": "时间加权收益率:把整个持有期拆成多段,对每段的 HPR 取几何平均,不受资金进出时点影响,是评价基金经理业绩的标准指标", "example_en": "If a client controls the timing of cash flows into and out of a portfolio, the time-weighted rate of return is most appropriate when evaluating the performance of the portfolio manager." },
    { "term_en": "opportunity cost", "meaning_zh": "机会成本:选择当前这个投资而放弃的、原本能从次优选项中获得的收益", "example_en": "If each CD has the same maturity and default risk, the opportunity cost of investing in CD 1 is closest to 2.2%." },
