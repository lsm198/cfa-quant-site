window.TOPIC_QUESTIONS = [
  ...
  {
    "id": "imported-006",
    "stem_en": "An asset earns 13.1% over a 16-month period. The asset's annualized compound  rate of return is closest to:",
    "choices_en": [
      "A. 9.3%.",
      "B. 9.7%.",
      "C. 9.8%."
  ...
  {
    "id": "imported-008",
    "stem_en": "A company estimates its revenue will be 50% higher than today in four years'  time. The compound annual growth rate is closest to:",
    "choices_en": [
      "A. 10.7%.",
      "B. 11.8%.",
      "C. 12.5%."
  ...
  {
    "id": "imported-009",
    "stem_en": "An investor purchased a stock for $450 and then sold the stock immediately after  receiving a dividend of $2. If the holding period return is a loss of 10.2%, the  investor sold the stock at a price closest to:",
    "choices_en": [
      "A. $402.",
      "B. $404.",
      "C. $406."
  ...
  {
    "id": "imported-010",
    "stem_en": "An investor considers the following certificates of deposit (CDs) available for  purchase at face value:  CD Interest Rate  1  2.2%  2  3.3%  3  4.4%  If each CD has the same maturity and default risk, the opportunity cost of    investing in CD 1 is closest to:",
    "choices_en": [
      "A. 0.0%.",
      "B. 1.1%.",
      "C. 2.2%."
  ...
  {
    "id": "imported-025",
    "stem_en": "An investor is considering buying a US T-bill. If the real risk-free rate is 1% and  the inflation premium is 2%, the investor's opportunity cost of failing to make  this investment is closest to:",
    "choices_en": [
      "A. 1%.",
      "B. 2%.",
      "C. 3%."
  ...
  {
    "id": "imported-037",
    "stem_en": "An investor summarizes end-of-year cash outlays and proceeds from a two-year  investment in a company's shares below.  Year  Outlays  Proceeds  0  $100 to purchase the  first share  ---  1  $110 to purchase the   second share  $10 dividend received from first  share (not  reinvested)  2  ---  $230 received from selling two shares at $115  per share  The annualized time-weighted rate of return of the investment over the two-year  period is closest to:",
    "choices_en": [
      "A. 9.7%.",
      "B. 12.0%.",
      "C. 12.3%."
  ...
  {
    "id": "imported-039",
    "stem_en": "For a given dataset with different non-negative observations, which of the  following will have the largest value?",
    "choices_en": [
      "A. Harmonic mean.",
      "B. Arithmetic mean.",
      "C. Geometric mean."
  ...
  {
    "id": "imported-055",
    "stem_en": "An investor invests a fixed amount of money into a fund each year for three years  as follows:  Year Term Deposit 1  1  €14.00  2  €12.00  3  €17.00  The investor's average cost per share is closest to:",
    "choices_en": [
      "A. €14.05.",
      "B. €14.33.",
      "C. €14.63."
  ...
  {
    "id": "imported-060",
    "stem_en": "Which of the following statements is most accurate? The money-weighted return:",
    "choices_en": [
  ...
  {
    "id": "imported-061",
    "stem_en": "In evaluating portfolio performance, the return measure most affected by an  addition of funds to the portfolio just before a market downturn is the:",
    "choices_en": [
  ...
  {
    "id": "imported-069",
    "stem_en": "The time preference of individuals for current instead of future real consumption  is captured by the:",
    "choices_en": [
      "A. liquidity premium.",
      "B. maturity premium.",
  ...
  {
    "id": "imported-074",
    "stem_en": "A bank offers a savings account with a stated annual rate of 3% in the first year  and 5% in the second year. If returns are compounded quarterly and €90,000 is   deposited in the account at the beginning of the first year, the account's value at  the end of the second year is closest to:",
    "choices_en": [
      "A. 697,200.",
      "B. 697,335.",
      "C. 697,455."
  ...
  {
    "id": "imported-078",
    "stem_en": "A pension fund needs to pay a lump sum $10,000,000 to its participants in 15  years. If the fund is expected to earn 5% per year compounded semi-annually, the  amount needed today to meet its liability in 15 years is closest to:",
    "choices_en": [
      "A. $4,767,427.",
      "B. $4,810,171.",
      "C. $4,892,771."
